...
public class Rainbow_SyntheticRainbowDynamic2D extends Slide {
	...
	public Rainbow_SyntheticRainbowDynamic2D(final RTO home, final String title) {
		super(home, title);
		drawhud = true;
	}
	...
	void normalDraw() {
		...
		psunangle = sunangle;
		sunangle = 15;// home.map(home.mouseY, 0, home.height, 60, 0);
		...
		for (int i = 0; i < numdrops; i++) {
			drop.set(home.random(-210, -190), home.random(-800, 400), home.random(-1500, 1500));
			...
			home.stroke((int) r, (int) g, (int) b, 150);
			home.fill((int) r, (int) g, (int) b, 150);
			home.pushMatrix();
			home.translate(drop.xf(), drop.yf(), drop.zf());
			home.ellipse(0, 0, 3, 3);
			home.popMatrix();
